...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.alexmercerind.kit_video_media.KitVideoMediaPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin kit_video_media, com.alexmercerind.kit_video_media.KitVideoMediaPlugin", e);
    }
    try {
